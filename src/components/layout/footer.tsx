    ...
    return (
        <footer className="w-full bg-white dark:bg-black border-t border-neutral-200/50 dark:border-white/10 relative pt-16 pb-8 transition-colors duration-500">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="border-t border-neutral-200/50 dark:border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-neutral-600 dark:text-neutral-600 text-xs font-mono">
                        &copy; {new Date().getFullYear()} {siteConfig.name}. All rights reserved.
                    </p>
                    <p className="text-neutral-600 dark:text-neutral-500 text-xs font-mono flex items-center gap-1">
                        Made with <Heart className="w-3 h-3 text-red-500 animate-pulse fill-red-500" /> by AIML CLUB
                    </p>
                </div>
            </div>
        </footer>
